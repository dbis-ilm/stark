 ...
 * @version 1.7
 */
public abstract class MyAbstractSTRtree implements Serializable {
   ...
   */
  protected static interface IntersectsOpI {
    /**
  ...
  protected void setRoot(AbstractNode root, int capactity) {
	  this.root = root;
	  this.nodeCapacity = capactity;
	  this.built = true;
  }
   ...
   */
  public MyAbstractSTRtree(int nodeCapacity) {
   ...
   * @see IntersectsOp
   */
  protected abstract IntersectsOpI getIntersectsOp();
