 ...
 * @version 1.7
 */
public class MySTRtree extends MyAbstractSTRtree 
...
//  static class MyIntersectsOp implements IntersectsOpI {
//	  public boolean intersects(Object aBounds, Object bBounds) {
//	      return ((Envelope)aBounds).intersects((Envelope)bBounds);
//	    }
//  }
//  
//  protected static IntersectsOpI intersectsOp = new MyIntersectsOp();
  
  private IntersectsOpI intersectsOp = new IntersectsOpI() {
    public boolean intersects(Object aBounds, Object bBounds) {
      return ((Envelope)aBounds).intersects((Envelope)bBounds);
    }
  };
  ...
  public void setRoot(AbstractNode root, int capacity) {
	  super.setRoot(root, capacity);
  }
  
  protected MySTRtree(AbstractNode root, int nodeCapactity) {
	  this(nodeCapactity);
	  setRoot(root, nodeCapactity);
  }
  ...
  protected IntersectsOpI getIntersectsOp() {
    return intersectsOp;
  }
